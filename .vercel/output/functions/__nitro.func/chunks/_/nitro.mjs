...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "92199fba-2628-4f16-a619-418b923ae740",
  ...
  "public": {
    "weatherApi": "https://api.openweathermap.org/data/2.5/weather?lat=10.3157&lon=123.8854&cnt=7&appid=6aa898ef1eb886f4a6985de4f22d634d",
    "content": {
      "wsUrl": ""
    },
    "mdc": {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "C:/Users/Jay/Documents/P1/weather/nuxt-weather-dashboard/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "icon": {
...
const _2Yw90y7khYoNo9LFU5zSd1Gk760_WCFq9FJJOn512I = (function(nitro) {
...
const plugins = [
  _2Yw90y7khYoNo9LFU5zSd1Gk760_WCFq9FJJOn512I
];
...
const _DdpaaY = defineCachedEventHandler(async (event) => {
...
const _QCIXVr = eventHandler(async (event) => {
...
const _kiKHjD = eventHandler(async (event) => {
...
const _dlFwAH = lazyEventHandler(() => {
...
const _lazy_nMrLbt = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_nMrLbt, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _DdpaaY, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump', handler: _QCIXVr, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _kiKHjD, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _dlFwAH, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_nMrLbt, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, createRouter$1 as A, defu as B, withLeadingSlash as C, withTrailingSlash as D, parseURL as E, encodeParam as F, encodePath as G, withoutTrailingSlash as H, useRuntimeConfig as a, buildAssetsURL as b, getResponseStatus as c, defineRenderHandler as d, publicAssetsURL as e, getQuery as f, getResponseStatusText as g, createError$1 as h, getRouteRules as i, hasProtocol as j, isScriptProtocol as k, joinURL as l, getContext as m, baseURL as n, klona as o, parseQuery as p, defuFn as q, createHooks as r, sanitizeStatusCode as s, toNodeListener as t, useNitroApp as u, isEqual as v, withQuery as w, stringifyParsedURL as x, stringifyQuery as y, toRouteMatcher as z };
