import { hasInjectionContext, getCurrentInstance, inject, defineAsyncComponent, defineComponent, createElementBlock, ref, provide, computed, h, createApp, onServerPrefetch, toRef, onErrorCaptured, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, isReadonly, isRef, isShallow, isReactive, toRaw, toValue, mergeProps, getCurrentScope, shallowRef, useSSRContext } from 'vue';
import { j as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch$1, n as baseURL, o as klona, q as defuFn, r as createHooks, h as createError$1, v as isEqual, x as stringifyParsedURL, y as stringifyQuery, p as parseQuery, z as toRouteMatcher, A as createRouter, B as defu } from '../_/nitro.mjs';
...
const LazyProseA = defineAsyncComponent(() => import('./ProseA-BqOSZt0S.mjs').then((r) => r["default"] || r.default || r));
...
const LazyProseH1 = defineAsyncComponent(() => import('./ProseH1-BAR8m0h7.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH2 = defineAsyncComponent(() => import('./ProseH2-Br7BGdY5.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH3 = defineAsyncComponent(() => import('./ProseH3-BKMAJZdO.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH4 = defineAsyncComponent(() => import('./ProseH4-VCqhd_fC.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH5 = defineAsyncComponent(() => import('./ProseH5-Ba8JO9Rn.mjs').then((r) => r["default"] || r.default || r));
const LazyProseH6 = defineAsyncComponent(() => import('./ProseH6-BHMMioqA.mjs').then((r) => r["default"] || r.default || r));
const LazyProseHr = defineAsyncComponent(() => import('./ProseHr-Bidow6pB.mjs').then((r) => r["default"] || r.default || r));
const LazyProseImg = defineAsyncComponent(() => import('./ProseImg-H5dzYTX-.mjs').then((r) => r["default"] || r.default || r));
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({
        class: ["weather-container", unref(theme)]
      }, _attrs))}><div class="weather-grid"><div class="weather-header"><h1>Weather</h1><div class="search-bar"><input${ssrRenderAttr("value", unref(city))} type="text" placeholder="Enter city..."><button>`);
      _push(ssrRenderComponent(_component_Icon, { name: "mdi-magnify" }, null, _parent));
      _push(`</button></div><button class="theme-toggle">`);
      _push(ssrRenderComponent(_component_Icon, {
        name: unref(theme) === "dark" ? "mdi-weather-sunny" : "mdi-weather-night"
      }, null, _parent));
      _push(`</button></div><div class="separator"></div>`);
      if (unref(weather)) {
        _push(`<div class="weather-content"><div class="weather-main"><img${ssrRenderAttr("src", unref(iconUrl))}${ssrRenderAttr("alt", unref(weather).weather[0].description)}><div><h2>${ssrInterpolate(celsius(unref(weather).main.temp))}°C</h2><p>${ssrInterpolate(unref(weather).weather[0].main)}</p></div></div><div class="weather-details-card"><div class="detail-card">`);
        _push(ssrRenderComponent(_component_Icon, { name: "mdi-water-percent" }, null, _parent));
        _push(`<div class="separator"></div><label>Humidity: ${ssrInterpolate(unref(weather).main.humidity)}%</label></div><div class="detail-card">`);
        _push(ssrRenderComponent(_component_Icon, { name: "mdi-weather-windy" }, null, _parent));
        _push(`<div class="separator"></div><label>Wind Speed: ${ssrInterpolate(unref(weather).wind.speed)} m/s</label></div><div class="detail-card">`);
        _push(ssrRenderComponent(_component_Icon, { name: "mdi-cloud-outline" }, null, _parent));
        _push(`<div class="separator"></div><label>Cloudiness: ${ssrInterpolate(unref(weather).clouds.all)}%</label></div><div class="detail-card">`);
        _push(ssrRenderComponent(_component_Icon, { name: "mdi-gauge" }, null, _parent));
        _push(`<div class="separator"></div><label>Pressure: ${ssrInterpolate(unref(weather).main.pressure)} hPa</label></div></div></div>`);
      } else {
        _push(`<div class="loading"><p>Loading weather...</p></div>`);
      }
      _push(`</div></div>`);
    };
  }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BMEAesxe.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-CAnrhXRE.mjs'));
